function ImageNet_detection_testset(fast_rcnn_net, opts, proposal_detection_model, rpn_net,folder_index)
%% script for detecting objects from FBMS dataset by Faster RCNN
% set data path
dataDir = '/BS/databases/imagenet/ILSVRC2015_VIS/Data/VID/test/';
Type = '*.JPEG';
