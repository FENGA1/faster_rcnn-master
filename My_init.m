function [ fast_rcnn_net, opts, proposal_detection_model, rpn_net ] = My_init()
%my init to avoid matlab crash
%   Detailed explanation goes here

% settings for faster rcnn; see script_faster_rcnn_demo()
%clear mex;
clear is_valid_handle; % to clear init_key
run('/home/zhongjie/CodesDown/jointmulticut/joint-multicut/faster_rcnn-master/startup');
%% -------------------- CONFIG --------------------
